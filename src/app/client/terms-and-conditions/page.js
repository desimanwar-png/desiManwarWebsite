    ...
    <div className="px-4 lg:px-20">
      <div className="min-h-screen px-6 py-10 md:px-16 lg:px-32 bg-primary-base text-secondary-dark dark:bg-secondary-dark dark:text-gray-100">
        ...
        <section className="space-y-6 text-base leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold text-secondary-dark dark:text-accent-base mt-10">
            I. Interpretation and Definitions
          </h2>
          <h3 className="text-xl font-medium text-secondary-base dark:text-white mt-6">
            Interpretation
          </h3>
          <p>
          ...
          <div className="text-justify">
            ...
            <h4>For the purposes of these Terms and Conditions:</h4>
            <ul className="list-disc pl-6">
              ...
              <li>
                ...
                Us or Our in this Agreement) refers to Desi Manwar Private
                Limited, Jaipur.
              </li>
              <li>
          ...
          <p className="text-justify">
            ...
            through the Service or 100 USD if You have not purchased anything
          ...
          <h2 className="text-2xl font-semibold text-secondary-dark dark:text-accent-base mt-10">
            VI. AS IS and AS AVAILABLE Disclaimer
          </h2>
          <p className="text-justify">
          ...
          <ul className="list-disc pl-6">
            <li>
              <strong>For European Union (EU) Users</strong>If You are a
            ...
            <li>
              <strong>United States Legal Compliance</strong>You represent and
              warrant that (i) You are not located in a country that is subject
              to the United States government embargo, or that has been
              designated by the United States government as a{' '}
              <strong>terrorist supporting</strong> country, and (ii) You are
          ...
          <p className="text-justify">
            If you have any questions regarding this Terms & Condition or the

  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createUser(
        formData.name,
        `${formData.username}@desimanwar.com`,
        formData.password
      )
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <span className="inline-flex items-center px-3 h-11 text-base text-gray-900 bg-gray-200 rounded-r-md border border-l-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                        @desimanwar.com
                      </span>
                    </div>
